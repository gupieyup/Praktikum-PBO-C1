...
public class MManusia {
    public static void main(String[] args) {
        ...
        System.out.println("\n ----- INFORMASI PNS ----- \n");
        p1.printInfo();
        System.out.println("Pajak: " + p1.hitungPajak());
        System.out.println("Masa Kerja: " + p1.hitungMasaKerja() + " tahun");
        System.out.println("\n");
        p2.printInfo();
        System.out.println("Pajak: " + p2.hitungPajak());
        System.out.println("Masa Kerja: " + p2.hitungMasaKerja() + " tahun");
        
        System.out.println("\n ----- INFORMASI PENGUSAHA ----- \n");
        pe1.printInfo();
        System.out.println("Pajak: " + pe1.hitungPajak());
